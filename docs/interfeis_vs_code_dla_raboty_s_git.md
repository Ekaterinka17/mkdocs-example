...
=== "Create new branch from (1)"
    ...
    Для создания новой ветки от другой ветки (не текущей) используется команда *Create new branch from*, выбирается нужная ветка из списка и вводится наименование новой ветки (аналог команд `git checkout <имя_ветки_от_которой_будет_создана_новая>`, `git branch <имя_новой_ветки>`).
